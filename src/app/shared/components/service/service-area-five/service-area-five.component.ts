...
@Component({
  selector: 'app-service-area-five',
  standalone: true,
  imports: [CommonModule,RouterModule],
  templateUrl: './service-area-five.component.html',
  styleUrl: './service-area-five.component.scss'
})
export class ServiceAreaFiveComponent {
  ...
  public service_data = [
    ...
    },
    {
      id:5,
      icon:`<svg width="28" height="28" viewBox="0 0 28 28" fill="none">
      <path d="M2.97748 18.651L9.3544 25.0343C11.9727 27.6552 16.224 27.6552 18.8564 25.0343L25.0362 18.8483C27.6546 16.2274 27.6546 11.9718 25.0362 9.33681L18.6453 2.96763C17.3079 1.62898 15.4638 0.910335 13.5775 1.00897L6.53898 1.34716C3.72357 1.47398 1.48532 3.71446 1.34454 6.51859L1.0067 13.5641C0.922233 15.4664 1.64016 17.3124 2.97748 18.651Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path opacity="0.5" d="M10.4802 14.0016C12.4238 14.0016 13.9995 12.4244 13.9995 10.4788C13.9995 8.53325 12.4238 6.95605 10.4802 6.95605C8.53657 6.95605 6.96094 8.53325 6.96094 10.4788C6.96094 12.4244 8.53657 14.0016 10.4802 14.0016Z" stroke="white" stroke-width="2" stroke-linecap="round"/>
      <path opacity="0.5" d="M15.4072 21.0471L21.0381 15.4106" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
   </svg>`,
      title:'Powerful Blog',
      subtitle:'Understand the business model of your product. Know your customers, value propositions.',
    },
    {
      ...
      <path opacity="0.4" d="M22.4104 20.2784L22.9174 24.3863C23.0474 25.4652 21.8905 26.2192 20.9675 25.6602L15.5206 22.4233C14.9227 22.4233 14.3377 22.3844 13.7657 22.3064C14.7277 21.1754 15.2997 19.7454 15.2997 18.1984C15.2997 14.5066 12.1018 11.5167 8.14987 11.5167C6.64192 11.5167 5.25097 11.9457 4.094 12.6996C4.055 12.3747 4.04199 12.0496 4.04199 11.7117C4.04199 5.79684 9.17684 1 15.5206 1C21.8644 1 26.9993 5.79684 26.9993 11.7117C26.9993 15.2216 25.1924 18.3285 22.4104 20.2784Z" stroke="#04121F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M15.2996 18.1983C15.2996 19.7453 14.7276 21.1753 13.7656 22.3063C12.4787 23.8662 10.4377 24.8671 8.14978 24.8671L4.75688 26.8821C4.1849 27.233 3.45692 26.7521 3.53492 26.0891L3.85991 23.5282C2.11796 22.3193 1 20.3823 1 18.1983C1 15.9104 2.22197 13.8955 4.09391 12.6995C5.25088 11.9456 6.64183 11.5166 8.14978 11.5166C12.1017 11.5166 15.2996 14.5064 15.2996 18.1983Z" stroke="#04121F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
   </svg> `,
