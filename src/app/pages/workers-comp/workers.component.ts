...
import { WcFormComponent } from '../../shared/components/form/wc-form/wc-form.component';


@Component({
  selector: 'app-about',
  standalone: true,
  imports: [CommonModule,HeaderTwoComponent,FooterTwoComponent, WcFormComponent],
...
export class WorkersComponent {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle('NC Workers Compensation Attorneys | Wallace & Graham');
