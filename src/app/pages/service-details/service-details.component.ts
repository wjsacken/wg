...
export class ServiceDetailsComponent {
  ...
  public nav_items = [
    {id: 'one', title: 'Mobile App',icon:`<svg width="22" height="26" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {id:'two', title: 'Speed Optimized',active:true,icon:`<svg width="24" height="27" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {id:'three', title: 'No Skills Needed',icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {id:'four', title: 'Google Analytics',icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {id:'five', title: 'Pixel Perfect',icon:`<svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
